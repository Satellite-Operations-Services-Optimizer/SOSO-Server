...
def image_order_from_json(image_order_json):
    num_of_revisits = 0 if type(image_order_json["Recurrence"])==list else image_order_json["Recurrence"].get("NumberOfRevisits")
    number_of_visits = (num_of_revisits or 0)+1
