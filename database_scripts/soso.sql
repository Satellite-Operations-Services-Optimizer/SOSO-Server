...
CREATE TABLE IF NOT EXISTS schedule_request (
	...
	uplink_size double precision NOT NULL, -- there are some things we don't uplink/downlink, they will just have the default value of 0 for their uplink/downlink data size
	downlink_size double precision NOT NULL,
	priority integer DEFAULT 1 NOT NULL,
...
GROUP BY schedule_id, satellite_id, snapshot_time, storage_capacity; -- aggregate changes to the load made at the same time into one change
